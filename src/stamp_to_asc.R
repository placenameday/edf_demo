...
stamp_asc_fu <- function(ascid, ascdic=ac, outputdic=bc){
  ...
  fix_csvfile <- paste(outputdic, "fix/", ascid, "_fix.csv", sep = "")
  sacc_csvfile <- paste(outputdic, "sacc/", ascid, "_sacc.csv", sep = "")
  blinks_csvfile <- paste(outputdic, "blinks/", ascid, "_blinks.csv", sep = "")
  raw_csvfile <- paste(outputdic, "raw/", ascid, "_raw.csv", sep = "")
  msg_csvfile <- paste(outputdic, "msg/", ascid, "_msg.csv", sep = "")
