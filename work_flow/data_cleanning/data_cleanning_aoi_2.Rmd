...
sub_bg_aoi <- function(dt){
  if ("sxp" %in% colnames(dt)) {
    ...
    if (nrow(ndt1)==0) {
      ...
      ndt1 <- ndt1 %>% rowwise() %>%
        mutate(bg=bg_de(c(b1_2_q,b1_2_a, outter_lt, outter_rt, outter_lb, outter_rb, outter_l, outter_r, outter_t, outter_b)))
    }
    ...
    if (nrow(ndt2)==0) {
      ...
      ndt2 <- ndt2 %>% rowwise() %>%
        mutate(bg=bg_de(c(b2_left,b2_center,b2_right, outter_lt, outter_rt, outter_lb, outter_rb, outter_l, outter_r, outter_t, outter_b)))
    }
    ...
    if (nrow(ndt3)==0) {
      ...
      ndt3 <- ndt3 %>% rowwise() %>%
        mutate(bg=bg_de(c(b4_text, outter_lt, outter_rt, outter_lb, outter_rb, outter_l, outter_r, outter_t, outter_b)))
    }
    ...
    if (nrow(ndt4)==0) {
      ...
      ndt4 <- ndt4 %>% rowwise() %>%
        mutate(bg=bg_de(c(b5_q,b5_a_1,b5_a_2,b5_a_3,b5_a_4, outter_lt, outter_rt, outter_lb, outter_rb, outter_l, outter_r, outter_t, outter_b)))
    }
    ...
    if (nrow(ndt5)==0) {
      ...
      ndt5 <- ndt5 %>% rowwise() %>%
        mutate(bg=bg_de(c(b5_q,b5_a_1,b5_a_2,b5_a_3,b5_a_4,b5_a_5,b5_a_6, outter_lt, outter_rt, outter_lb, outter_rb, outter_l, outter_r, outter_t, outter_b)))
    }
  } else  {
      ...
      if (nrow(ndt1)==0) {
        ...
        ndt1 <- ndt1 %>% rowwise() %>%
          mutate(bg=bg_de2(c(b1_2_q,b1_2_a, outter_lt, outter_rt, outter_lb, outter_rb, outter_l, outter_r, outter_t, outter_b)))
      }
      ...
      if (nrow(ndt2)==0) {
        ...
        ndt2 <- ndt2 %>% rowwise() %>%
          mutate(bg=bg_de2(c(b2_left,b2_center,b2_right, outter_lt, outter_rt, outter_lb, outter_rb, outter_l, outter_r, outter_t, outter_b)))
      }
      ...
      if (nrow(ndt3)==0) {
        ...
        ndt3 <- ndt3 %>% rowwise() %>%
          mutate(bg=bg_de2(c(b4_text, outter_lt, outter_rt, outter_lb, outter_rb, outter_l, outter_r, outter_t, outter_b)))
      }
      ...
      if (nrow(ndt4)==0) {
        ...
        ndt4 <- ndt4 %>% rowwise() %>%
          mutate(bg=bg_de2(c(b5_q,b5_a_1,b5_a_2,b5_a_3,b5_a_4, outter_lt, outter_rt, outter_lb, outter_rb, outter_l, outter_r, outter_t, outter_b)))
      }
      ...
      if (nrow(ndt5)==0) {
        ...
        ndt5 <- ndt5 %>% rowwise() %>%
          mutate(bg=bg_de2(c(b5_q,b5_a_1,b5_a_2,b5_a_3,b5_a_4,b5_a_5,b5_a_6, outter_lt, outter_rt, outter_lb, outter_rb, outter_l, outter_r, outter_t, outter_b)))
      }
  }
...
mul_aoi <- function(in_dir, out_dir){
  ...
  future_map2(in_list, out_list, sub_aoi, a_path=a_path, pb2=pb2)
}
...
运行函数`mul_aoi(d,o)`对相应数据文件进行批量打标
