...
# 针对timezone对数据进行切割
dt3_1 <- dt3 %>% filter(between(Time,0,8500)) %>% mutate(Time2=Time)
dt3_2 <- dt3 %>% filter(between(Time,8500,17300)) %>% mutate(Time2=Time, Time=Time-8500)
dt3_3 <- dt3 %>% filter(between(Time,17300,25600)) %>% mutate(Time2=Time, Time=Time-17300)
