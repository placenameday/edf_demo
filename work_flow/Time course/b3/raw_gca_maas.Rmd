...
# 针对timezone对数据进行切割
dt3_1 <- dt3 %>% filter(between(Time,0,10000)) %>% mutate(Time2=Time)
dt3_2 <- dt3 %>% filter(between(Time,10000,20000)) %>% mutate(Time2=Time, Time=Time-10000)
dt3_3 <- dt3 %>% filter(between(Time,20000,30000)) %>% mutate(Time2=Time, Time=Time-20000)
