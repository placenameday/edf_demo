...
```{r, message=FALSE, warning=FALSE}
nk <- read_csv("/Users/placenameday/R study/edf_demo/data/processed/eye_tacking/ea/data/b3_timec_pwc_maas_a.csv")
...
p4 <- ggplot(dt_v, aes(x=Time, y=Prop, color=AOI)) +
  ...
  labs(x="Time(s)")+
  scale_x_continuous(breaks = c(0,8.5,17.3,25.6,30))
