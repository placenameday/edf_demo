...
dt <- read_csv("/Users/placenameday/R study/edf_demo/data/processed/eye_tacking/ea/data/raw_time_b3_sas.gz") %>%
  select(1:7,10,13) %>% filter(Target!="mid") %>%
  mutate(Target=case_when(Target=="high"~"HPA",
                          Target=="low"~"LPA"),
...
dt3$Target <- factor(dt3$Target, levels=c("LPA", "HPA"))
...
write_csv(nk, "/Users/placenameday/R study/edf_demo/data/processed/eye_tacking/ea/data/b3_timec_pwc_sas_a.csv")
