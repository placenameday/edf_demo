...
p.2 <- ggplot(dt3_2, aes(x=Time2/1000, y=Elog, color=AOI)) +
                     ...
                     coord_cartesian(ylim = c(-3.5, -0.5)) +
                     scale_x_continuous(breaks = c(7.9,10,12,14,16,18))
...
fig3 <- p123 + plot_layout(widths = c(4, -0.3 ,4.5,-0.3 ,3.5), guides = "collect")
fig3
#ggsave(filename = "/Users/placenameday/Downloads/fig3.pdf", width = 180, height = 120, units = "mm")
```
