...
计算总体线性回归结果并保存`write_excel_csv(mu(dtb, "lm"),"/Users/placenameday/R study/edf_demo/data/processed/eye_tacking/ea/anova/over_all_lm_jh.csv")`
...
```
计算aoi线性回归结果并保存`write_excel_csv(mu_a(dtb_aoi, "lm"),"/Users/placenameday/R study/edf_demo/data/processed/eye_tacking/ea/anova/aoi_lm_jh.csv")`
